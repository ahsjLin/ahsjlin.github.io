...
%____________
題目\\
\includegraphics[width=\textwidth]{./images/Do_inverse_matrix_create_vector_space.png}\\
解:\\
有個集合裡包含了所以$n$ by $n$且可逆的的矩陣，那這集合能否為矩陣空間$R^{nXn}$的子空間?\\
答案為否，因為$R^{nXn}$的子空間必包含零矩陣，零矩陣不可逆，所以集合裡沒有零矩陣，也就不是子空間。
%------------
%-- Finish --
%------------
} % for fontfamily
