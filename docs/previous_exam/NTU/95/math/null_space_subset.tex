...
%-- Start ---
%------------
\title{判斷後矩陣的核空間是否為兩矩陣乘積後核空間的子集\\95台大電機}
\author{\textbf{sjLin}}
%\date{}
\begin{document}
% bsmi
...
%____________
題目\\
\includegraphics[width=\textwidth]{./images/nullspace_subset.png}\\
解:\\
題目問是否為$N(B)\subseteq N(AB)$\\
$N(B)=\{x|Bx=0\}$\\
$N(AB)=\{x|ABx=0\}$\\
因為$ABx=A(Bx)=A\cdot 0 = 0$，
\\所以$\forall x\in B$，則$\forall x\in AB$
\\$\Rightarrow N(B)\subseteq N(AB)$, 答案為true.
%------------
%-- Finish --
%------------
} % for fontfamily
